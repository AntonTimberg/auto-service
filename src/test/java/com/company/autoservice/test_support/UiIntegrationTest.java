package com.company.autoservice.test_support;

import com.company.autoservice.AutoServiceApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.autoservice.screen")
@ContextConfiguration(classes = {AutoServiceApplication.class, UiTestAssistConfiguration.class})
